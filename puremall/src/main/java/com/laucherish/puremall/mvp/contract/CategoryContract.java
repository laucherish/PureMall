...
public interface CategoryContract {
    ...
    interface View extends IView {
        void refreshData(CategoryListBean categoryList);

        void refreshCategory(CategoryListBean categoryList);
    }
    ...
    interface Model extends IModel {
        ...
        Observable<BaseResponse<CategoryListBean>> getCategory(int id);
    }
}
